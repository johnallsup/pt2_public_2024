...
class TypingPractice {
  ...
  setLineMultiple(i) {
    ...
    let msource = lines2.join("\n")
    this.textArea.dom.remove()
    this.textArea = new TextArea(this,this.mainArea,msource)
    this.textArea.clearTotalErrors()
    this.textArea.setPos(0,0)
  }
  handleKey(e) {
